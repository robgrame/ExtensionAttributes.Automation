...
using Nimbus.ExtensionAttributes.WorkerSvc.Jobs;
using Nimbus.ExtensionAttributes.WorkerSvc.JobUtils;
using Nimbus.ExtensionAttributes.WorkerSvc.HealthChecks;
...
using Nimbus.ExtensionAttributes.Intune.Config;
...
namespace Nimbus.ExtensionAttributes.WorkerSvc.Services
{
    public class ServiceRegistrationService
    {
        ...
        public static void ConfigureWebApplication(WebApplication app)
        {
            ...
            // Map SignalR hubs
            app.MapHub<Nimbus.ExtensionAttributes.WorkerSvc.Hubs.AuditHub>("/hubs/audit");
